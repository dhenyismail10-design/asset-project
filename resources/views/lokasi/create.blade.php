...
<div class="container-fluid p-0" style="max-width: 700px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="fw-800 text-slate-900 mb-1" style="font-weight: 800; letter-spacing: -0.5px;">Tambah Lokasi Baru</h2>
            <p class="text-muted mb-0 font-medium">Buat lokasi penyimpanan atau penempatan aset inventaris baru.</p>
        </div>
            ...
            <form action="{{ route('lokasi.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nama_lokasi" type="text" name="nama_lokasi" class="form-control border-start-0 @error('nama_lokasi') is-invalid @enderror" style="border-radius: 0 10px 10px 0;" value="{{ old('nama_lokasi') }}" placeholder="Masukkan nama lokasi (contoh: Gudang Utama, Lab Komputer)" required autofocus>
                        @error('nama_lokasi')
                ...
                <div class="mb-4">
                    ...
                    <textarea id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Masukkan alamat atau detail lokasi (opsional)">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
