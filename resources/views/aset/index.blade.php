    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <p>Master Aset</p>
                <li>
                    <a href="{{ Route::has('aset.index') ? route('aset.index') : url('/aset') }}" class="active">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold text-dark mb-1">
                        <i class="bi bi-boxes me-2 text-primary"></i>Manajemen Data Aset
                    </h2>
                    <p class="text-muted mb-0">Kelola dan pantau seluruh inventaris serta aset organisasi secara terpusat.</p>
                </div>
                <div>
                    <a href="{{ Route::has('aset.create') ? route('aset.create') : url('/aset/create') }}" class="btn btn-primary fw-semibold">
