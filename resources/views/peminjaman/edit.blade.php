...
<head>
    ...
    <title>Edit Peminjaman Aset</title>
...
<body class="p-4 bg-light">
    ...
    <div class="container my-3" style="max-width: 700px;">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                <h3 class="fw-bold text-dark mb-0">Edit Peminjaman Aset</h3>
                <p class="text-muted mb-0 small">Perbarui data peminjaman di bawah ini.</p>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('peminjaman.update', $peminjaman->id) }}" method="POST">
                        ...
                        <select name="asset_id" id="asset_id" class="form-select" required>
                            ...
                            @foreach($assets as $asset)
                                <option value="{{ $asset->id }}" {{ old('asset_id', $peminjaman->asset_id) == $asset->id ? 'selected' : '' }}>
                                    {{ $asset->nama_barang }} ({{ $asset->kode_barang ?? 'Tanpa Kode' }}) - Kondisi: {{ $asset->kondisi }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="peminjam" id="peminjam" class="form-control" value="{{ old('peminjam', $peminjaman->peminjam) }}" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="tanggal_kembali" id="tanggal_kembali" class="form-control" value="{{ old('tanggal_kembali', $peminjaman->tanggal_kembali) }}">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-2 border-top">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="bi bi-save me-1"></i> Perbarui Peminjaman
                        </button>
                    </div>
