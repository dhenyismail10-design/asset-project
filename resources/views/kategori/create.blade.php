...
<div class="container-fluid p-0" style="max-width: 700px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="fw-800 text-slate-900 mb-1" style="font-weight: 800; letter-spacing: -0.5px;">Tambah Kategori Baru</h2>
            <p class="text-muted mb-0 font-medium">Buat kategori baru untuk mengelompokkan aset inventaris.</p>
        </div>
            ...
            <form action="{{ route('kategori.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input id="nama_kategori" type="text" name="nama_kategori" class="form-control border-start-0 @error('nama_kategori') is-invalid @enderror" style="border-radius: 0 10px 10px 0;" value="{{ old('nama_kategori') }}" placeholder="Masukkan nama kategori (contoh: Elektronik, Mebel)" required autofocus>
                        @error('nama_kategori')
